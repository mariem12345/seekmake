              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    ...
                    <a href="{{ url('/seekmakeadminprivate/edit-product/'.$product->id) }}" class="btn btn-primary btn-mini">Edit</a> 
                    <a href="{{ url('/seekmakeadminprivate/add-attributes/'.$product->id) }}" class="btn btn-success btn-mini">Add</a>
                    <a href="{{ url('/seekmakeadminprivate/add-images/'.$product->id) }}" class="btn btn-info btn-mini">Add</a>
