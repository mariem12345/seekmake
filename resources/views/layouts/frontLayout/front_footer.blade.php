<footer id="footer"><!--Footer-->
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							...
							<p> Premier service en ligne d'impression 3D et de découpe laser en Tunisie • livraison gratuite • qualité garantie.</p>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="https://www.youtube.com/watch?v=F6bltj09paM" target="blank"><i class="fa fa-youtube" ></i></a></li>
							</ul>
						</div>
					</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2019 SeekMake All rights reserved.</p>
