...
class ProductsController extends Controller
{
    ...
    public function addtocart(Request $request){
        ...
        return redirect('cart')->with('flash_message_success','Le produit a été ajouté au panier!');
    ...
    public function updateCartQuantity($id=null,$quantity=null){
        ...
        if($getProductStock->stock>=$updated_quantity){
            ...
            return redirect('cart')->with('flash_message_success','La quantité de produit a été mise à jour dans le panier!');
        }else{
    ...
    public function deleteCartProduct($id=null){
        ...
        return redirect('cart')->with('flash_message_success','Le produit a été supprimé du panier!');
    }
    ...
    public function checkout(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            if(empty($data['billing_name']) || empty($data['billing_address']) || empty($data['billing_city']) || empty($data['billing_state']) ||  empty($data['billing_pincode']) || empty($data['billing_mobile']) || empty($data['shipping_name']) || empty($data['shipping_address']) || empty($data['shipping_city']) || empty($data['shipping_state']) || empty($data['shipping_pincode']) || empty($data['shipping_mobile'])){
                    return redirect()->back()->with('flash_message_error','Remplissez tous les champs pour continuer!');
            }
...
*/
                ...
                Mail::send('emails.order',$messageData,function($message) use($email){
                    $message->to($email)->subject('Order Placed -Seekmake shop');
                });
